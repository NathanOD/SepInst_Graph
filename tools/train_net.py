# Code partially taken from detectron2/tools/train_net.py
import os
import sys
import itertools
import torch
...
sys.path.append(".")
from custom_model import COCOMaskEvaluator
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        if cfg.MODEL.DATASET_MAPPER == "RGBDDatasetMapper":
            from custom_model import RGBDDatasetMapper
...
def setup(args):
    ...
    #setup_logger(output=cfg.OUTPUT_DIR, distributed_rank=comm.get_rank(), name="SepInst")
    return cfg
