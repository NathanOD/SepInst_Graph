    ...
    def forward_mask(self, features, features_depth, instances):
        ...
        if self.training:
            ...
            if self.use_depth:
                ...
                # Fusion Module
                fused_mask_features = self.fusion_module(mask_features, depth_mask_features)
            else:
                fused_mask_features = mask_features
            # RGB Mask Head
            rgb_masks, _ = self.rgb_mask_head(fused_mask_features)
            # Compute losses
