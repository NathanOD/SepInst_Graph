# This file is a modified version of fcos_outputs.py in https://github.com/aim-uofa/AdelaiDet
import torch
...
from .utils import reduce_mean, compute_ious, ml_nms, IOULoss
...
class FCOSOutputs(nn.Module):
    ...
    def predict_proposals(
        ...
        for i, per_bundle in enumerate(zip(*bundle.values())):
            ...
            sampled_boxes.append(self.forward_for_single_feature_map(l, o, r, c, image_sizes))
    ...
    def forward_for_single_feature_map(
        ...
        for i in range(N):
            ...
            detections = self.clip_boxes_to_image(detections, image_sizes[i])
            ...
            # Added logits
            #if len(per_box_loc) > 0:
            #    aligned_logits = logits_pred[i, per_box_loc][:len(per_box_cls)]
            #else:
            #    aligned_logits = logits_pred[i, :len(per_box_cls)]
            #boxlist.logits = aligned_logits
            if top_feat is not None:
    ...
    def select_over_all_levels(self, boxlists):
        ...
        # Added logits to the final result
        #result.logits = result.logits[keep]
        # Correctly slice logits as well
