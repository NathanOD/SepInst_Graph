# This file is a modified version of fcos.py in https://github.com/aim-uofa/AdelaiDet
import math
...
from .utils import DFConv2d, NaiveGroupNorm
...
class FCOS(nn.Module):
    ...
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        self.fcos_outputs = FCOSOutputs(cfg, self.fpn_strides)
    ...
    def forward(self, images, features, gt_instances=None, top_module=None):
        ...
        results = self.fcos_outputs.predict_proposals(logits_pred, reg_pred, ctrness_pred, locations, images.image_sizes, top_feats)
        #losses = {}
        if self.training:
            _, losses = self.fcos_outputs.losses(
...
def build_proposal_generator(cfg, input_shape: Dict[str, ShapeSpec]):
